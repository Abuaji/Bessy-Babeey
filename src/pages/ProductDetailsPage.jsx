        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '50px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <a href={`#/cart?id=${p.id}`} className="product-card__btn-buy" style={{ padding: '16px 32px', fontSize: '1.1rem', textDecoration: 'none', textAlign: 'center' }}>Add to Cart</a>
              <a href={`#/cart?id=${p.id}`} className="product-card__btn-cart" style={{ padding: '16px 32px', fontSize: '1.1rem', textDecoration: 'none', textAlign: 'center' }}>Buy it Now</a>
            </div>
          </div>
        </div>
      </div>
